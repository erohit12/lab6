...
@app.route('/records/description_by_bandnalbum/<bandname>/<album>/', methods=['GET'])
def get_description_by_bandnalbum(album, bandname):
	response={bandname:'Not Found!',album:'Not Found'}
	for item in all_records:
		if item['name']==bandname:
